...
export default function FeaturedInfo() {
  ...
  useEffect(() => {
    const getCountUsers = async () => {
      try {
        const res = await userRequest.get("https://mindfulness-portal.herokuapp.com/api/v1/user");
  ...
  useEffect(() => {
    const getCountCategory = async () => {
      try {
        const res = await userRequest.get("https://mindfulness-portal.herokuapp.com/api/v1/orders");
  ...
  useEffect(() => {
    const getCountPosts = async () => {
      try {
        const res = await userRequest.get("https://mindfulness-portal.herokuapp.com/api/v1/products");
