...
export default function Article() {
  ...
  const URL = `https://mindfulness-portal.herokuapp.com/api/v1/article/find/${articleId}`;
  ...
  const URL_update = `https://mindfulness-portal.herokuapp.com/api/v1/article/${articleId}`;
