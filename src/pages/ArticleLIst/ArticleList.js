...
export default function ArticleList() {
  ...
  useEffect(() => {
    const userData = async () => {
      try {
        let response = await fetch("https://mindfulness-portal.herokuapp.com/api/v1/article", {
          method: "GET",
          headers: {
  ...
  const URL = `https://mindfulness-portal.herokuapp.com/api/v1/article/${postId}`;

  const URl_Update = `https://mindfulness-portal.herokuapp.com/api/v1/article/${postId}`;
