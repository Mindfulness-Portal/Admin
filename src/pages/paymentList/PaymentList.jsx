...
export default function PaymentList() {
  ...
  const URL = `https://mindfulness-portal.herokuapp.com/api/v1/checkout/${paymentId}`;

  const URl_Update = `https://mindfulness-portal.herokuapp.com/api/v1/checkout/${paymentId}`;
