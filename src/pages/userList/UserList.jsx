...
export default function UserList() {
  ...
  useEffect(() => {
    const userData = async () => {
      try {
        let response = await fetch("https://mindfulness-portal.herokuapp.com/api/v1/user", {
          method: "GET",
          headers: {
  ...
  const URL = `https://mindfulness-portal.herokuapp.com/api/v1/user/${userId}`;

  const URl_Update = `https://mindfulness-portal.herokuapp.com/api/v1/user/${userId}`;
